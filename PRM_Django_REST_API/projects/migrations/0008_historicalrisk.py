    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('background', models.CharField(choices=[('1', 'Finance'), ('2', 'Operations'), ('3', 'Staffing')], max_length=50)),
                ('priority', models.CharField(choices=[('1', 'Low'), ('2', 'Medium'), ('3', 'High')], max_length=10)),
                ('probability_percentage', models.CharField(choices=[('1', '10%'), ('2', '20%'), ('3', '30%'), ('4', '40%'), ('5', '50%'), ('6', '60%'), ('7', '70%'), ('8', '80%'), ('9', '90%'), ('10', '100%')], max_length=6)),
